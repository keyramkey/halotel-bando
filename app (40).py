...
# Bei za Leseni za Biashara (Halmashauri) — reference
LICENSE_CATALOG = [
    # 1. Maduka
    ...
    # 2. Hardware
    {"id": "hardware_city", "name": "Hardware & Building Materials (City/Municipal)", "price": 200000, "category": "Hardware"},
    {"id": "hardware_district", "name": "Hardware & Building Materials (District)", "price": 150000, "category": "Hardware"},
    {"id": "hardware_village", "name": "Hardware & Building Materials (Minor/Village)", "price": 60000, "category": "Hardware"},
    ...
    {"id": "appliances_village", "name": "Domestic Appliances Retail (Minor/Village)", "price": 50000, "category": "Hardware"},
    {"id": "electrical_city", "name": "Electrical & Household Items (City/Municipal)", "price": 150000, "category": "Hardware"},
    {"id": "electrical_district", "name": "Electrical & Household Items (District)", "price": 100000, "category": "Hardware"},
    {"id": "electrical_minor", "name": "Electrical & Household Items (Minor Settlement)", "price": 50000, "category": "Hardware"},
    {"id": "electrical_village", "name": "Electrical & Household Items (Village)", "price": 10000, "category": "Hardware"},
    ...
    {"id": "machinery_village", "name": "Machinery Tools (Minor/Village)", "price": 80000, "category": "Hardware"},
    ...
    # 4. Hotel
    {"id": "hotel_liquor", "name": "Non-Tourist Hotel (With Liquor)", "price": 100000, "category": "Hotel"},
    {"id": "hotel_no_liquor", "name": "Non-Tourist Hotel (Without Liquor)", "price": 80000, "category": "Hotel"},
    {"id": "lodging", "name": "Lodging House", "price": 100000, "category": "Hotel"},
    ...
    {"id": "tourist_hotel", "name": "Tourist Hotel", "price": 150000, "category": "Hotel"},
    {"id": "tourist_lodge", "name": "Tourist Lodge", "price": 150000, "category": "Hotel"},
    {"id": "tourist_camp", "name": "Tourist Camp", "price": 100000, "category": "Hotel"},
    {"id": "catering", "name": "Catering Services", "price": 200000, "category": "Hotel"},
    # 5. Salon
    {"id": "salon_city", "name": "Hair Salon/Barber (City/Municipal)", "price": 40000, "category": "Salon"},
    {"id": "salon_district", "name": "Hair Salon/Barber (District)", "price": 20000, "category": "Salon"},
    {"id": "salon_village", "name": "Hair Salon/Barber (Minor/Village)", "price": 5000, "category": "Salon"},
    {"id": "beauty_city", "name": "Beauty Clinic (City/Municipal)", "price": 40000, "category": "Salon"},
    {"id": "beauty_district", "name": "Beauty Clinic (District)", "price": 30000, "category": "Salon"},
    {"id": "beauty_village", "name": "Beauty Clinic (Minor/Village)", "price": 10000, "category": "Salon"},
    # 6. Food
    ...
    {"id": "bakery_village", "name": "Bakery (Minor/Village)", "price": 30000, "category": "Food"},
    ...
    {"id": "milling_village", "name": "Flour/Oil Milling (Minor/Village)", "price": 20000, "category": "Food"},
    ...
    {"id": "butchery_village", "name": "Butchery (Minor/Village)", "price": 10000, "category": "Food"},
    ...
    {"id": "tearoom_village", "name": "Tea Room (Minor/Village)", "price": 5000, "category": "Food"},
    ...
    {"id": "fish_village", "name": "Selling Fish (Minor/Village)", "price": 10000, "category": "Food"},
    # 7. Mitumba / books / print
    {"id": "bookstore_city", "name": "Bookstore & Stationery (City/Municipal)", "price": 100000, "category": "Vitabu"},
    {"id": "bookstore_district", "name": "Bookstore & Stationery (District/Town)", "price": 80000, "category": "Vitabu"},
    {"id": "bookstore_village", "name": "Bookstore & Stationery (Minor/Village)", "price": 20000, "category": "Vitabu"},
    {"id": "printing_city", "name": "Printing & Publishing (City/Municipal)", "price": 400000, "category": "Vitabu"},
    {"id": "printing_district", "name": "Printing & Publishing (District)", "price": 250000, "category": "Vitabu"},
    {"id": "printing_village", "name": "Printing & Publishing (Minor/Village)", "price": 100000, "category": "Vitabu"},
    # 8. Garage / mafuta
    ...
    {"id": "petrol_village", "name": "Petrol/Filling Station (Minor/Village)", "price": 100000, "category": "Magari"},
    # 9. Livestock
    ...
    {"id": "livestock_village", "name": "Livestock Trading (Minor/Village)", "price": 25000, "category": "Mifugo"},
    # 10. Health
    {"id": "dispensary", "name": "Dispensary/Health Centre/Laboratory", "price": 80000, "category": "Afya"},
    ...
    {"id": "mortgage_micro", "name": "Mortgage & Hire Purchase – Micro", "price": 100000, "category": "Fedha"},
    ...
    {"id": "cargo_valuation", "name": "Cargo Valuation/Survey (Local)", "price": 400000, "category": "Usafirishaji"},
    ...
    # 15. Insurance / real estate
    {"id": "general_insurance", "name": "General Insurance/Assurance (Local)", "price": 1000000, "category": "Bima"},
    {"id": "underwriting", "name": "Underwriting & Loss Assessment", "price": 600000, "category": "Bima"},
    {"id": "reinsurance", "name": "Re-insurance & Endowment", "price": 800000, "category": "Bima"},
    {"id": "real_estate", "name": "Real Estate (Local)", "price": 600000, "category": "Bima"},
    {"id": "property_mgmt", "name": "Property Management (Local)", "price": 500000, "category": "Bima"},
    {"id": "estate_agent", "name": "Estate Agent (Local)", "price": 400000, "category": "Bima"},
    {"id": "property_dev", "name": "Property Development (Local)", "price": 400000, "category": "Bima"},
    # 16. Telecom
    ...
    {"id": "tv_station", "name": "Radio/TV Transmission Station", "price": 300000, "category": "Media"},
    # 18. Manufacturing
    ...
    {"id": "export_finished", "name": "Export – Finished Goods", "price": 100000, "category": "Import/Export"},
...
def nakala_license():
    ...
    return render_template("nakala_license.html", licenses=LICENSE_CATALOG)
